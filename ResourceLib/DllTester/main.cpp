	...
	//	 gDevice->Release();
{
	...
	resHandle.SetDeviceAndContext(gDevice, gContext); //Set the device and context
	Resources::Model* model = nullptr;
	Resources::Model* placeHolder = nullptr;
	UINT modelId = 1337;		 //ids will come from the level file
	UINT levelID = 12;


	Resources::Status st = resHandle.LoadLevel(levelID); // load a level
